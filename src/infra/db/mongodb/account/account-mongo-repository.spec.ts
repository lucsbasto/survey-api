...
import { mockAddAccountParams, mockAddAccountWithRoleParams, mockAddAccountWithTokenParams } from '@/domain/test'
...
describe('Account Mongo Repository', () => {
  ...
  describe('loadByToken()', () => {
    test('Should return an account on loadByToken without role succeeds', async () => {
      const sut = makeSut()
  ...
  test('Should return an account on loadByToken with admin role', async () => {
    const sut = makeSut()
    await accountCollection.insertOne(mockAddAccountWithRoleParams())
